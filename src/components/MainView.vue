...
let design = {
  shaggy:ref(shaggy),
  idogsit:ref(idogsit),
  selectiontool:ref(selectiontool),
}
</script>
...
<!-- main view -->
 <div id="wrapper">
    ...
    <Section :enabled="Boolean(true)" id="scorekeeper" :pro-name="gadgets.scorekeeper.value.description" :pro-data="gadgets.scorekeeper" bgImage="scorekeeper" msg="Having trouble tracking scores in basketball games? Try out the scorekeeper! Program both teams of 5 players and track their scores by name."/>
    ...
    <Section :enabled="Boolean(false)" id="snake" :pro-name="games.snake.value.description" :pro-data="games.snake" bgImage="snake" msg="Classic snake game where you must survive eat food, and grow without running into walls...and yourself!"/>
    <!-- footer -->
    <Footer />
 </div>
</template>
